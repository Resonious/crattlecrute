...
if ARGV.include? 'noembed'
    ...
    system "gcc src/*.c -std=c99 build/crattlecrute.assets.o -ISTB -ISDL/include -IMRuby/include -LMRuby/build/host/lib -lSDL2 -lm -lmruby -DEMBEDDED_ASSETS -o build/crattlecrute #{debug_flags}"
